        ...
        >
          <div class="modal-content">
            ...
            <div class="modal-body">
              <BodyModal :infoTransfer="erc20Transfer" :loading="loading"/>
            </div>
...
import BodyModal from "@/components/matic/BodyModal.vue";
...
export default {
  ...
  methods: {
    ...
    getErc20TokenTransfer(contract, address) {
      this.erc20Transfer = ''
      this.loading = true
      console.log("oke gan siap" +  this.loading)
      let url = `https://api.covalenthq.com/v1/137/address/${address}/transfers_v2/`;
      axios
